...
<template>
  <section>
    <div class="d-flex align-items-center gap-2 mb-3">
      <LteButton class="action-button" :aria-label="t('common.back')" type="button" @click="emit('back')">
    ...
    >
      ...
      <div class="d-flex flex-wrap gap-2">
        <LteButton class="action-button" type="button" @click="load">
        ...
        <LteButton class="action-button" type="button" @click="keepEditing">
