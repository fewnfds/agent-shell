...
export const en: MessageSchema = {
  ...
  agents: {
    ...
    asyncSubagent: {
      referencesTitle: 'Async Main Agent references',
      addReference: 'Add async Main Agent',
      noReferences: 'No async Main Agent reference is configured.',
      target: 'Target Main Agent',
      name: 'Tool-facing name',
  ...
  validation: {
    ...
    resolution: {
      ...
      asyncSubagentNameDuplicate: 'Give each async Main Agent reference a unique tool-facing name.',
      asyncSubagentSelfReference: 'Select a different Main Agent as the async target.',
