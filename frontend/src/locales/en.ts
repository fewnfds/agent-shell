...
export const en: MessageSchema = {
  ...
  workflows: {
    ...
    responseStream: {
      ...
      description: 'Configure how lifecycle events are serialized into one append-only OpenAI assistant response. The policy is stored on the Parent Run Workflow only because each lifecycle has exactly one parent Workflow configuration owner.',
      ...
      sourcesLoadFailed: 'Could not load current Graph nodes',
