...
export const en: MessageSchema = {
  ...
  workflowLifecycles: {
    ...
    visualizationPendingTitle: 'Monitoring visualization in progress',
    visualizationPending: 'Runtime monitoring data and read APIs are active. This page currently provides the Lifecycle catalog and deletion controls; the graphical monitoring interface will be added next.',
