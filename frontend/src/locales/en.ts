...
export const en: MessageSchema = {
  ...
  systemSettings: {
    ...
    apiServer: 'Agent Shell API Server',
    ...
    apiServerSaved: 'Agent Shell API Server settings saved.',
    ...
    apiServerSaveFailed: 'Could not save Agent Shell API Server settings',
