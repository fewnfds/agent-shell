...
export const en: MessageSchema = {
  ...
  mcp: {
    connections: {
      ...
      transportStdio: 'Local package (stdio)',
    ...
    installation: {
      ...
      failedCode: 'Failure code: {code}',
      entrypoints: 'Available entrypoints: {names}',
      succeeded: 'MCP installed and {count} Tools were discovered.',
      failed: 'Could not install or test the MCP package',
    },
    mapping: {
      ...
      stdioSummary: "{name} · Local package · {package}{'@'}{version}",
  ...
  workflows: {
    ...
    durability: {
      sync: 'sync (finish each write before continuing)',
      async: 'async (write alongside the next step)',
      exit: 'exit (write when the Run exits)',
    },
    onDisconnect: {
      cancel: 'Cancel every active Run in this Lifecycle',
      continue: 'Let every Run in this Lifecycle continue',
    },
    seconds: 'seconds',
    kilobytes: 'KB',
  },
  workflowLifecycles: {
    ...
    loadFailed: 'Could not load the runtime catalog',
    ...
    deleteTitle: 'Delete runtime data',
    deleteDescription: 'Delete official Threads, Runs, State/history, and Lifecycle Store records for “{name}”? Files and directories created during runs are retained.',
    deleted: 'Runtime data deleted.',
    deleteFailed: 'Could not delete runtime data',
    bulkDelete: {
      action: 'Bulk delete',
  ...
  runtimeMonitoring: {
    ...
    scope: {
      ...
      workflow: 'Workflow and descendants',
      run: 'Single Run',
    ...
    runIndex: {
      title: 'Runs',
      ariaLabel: 'Workflow Runs in this Lifecycle',
      count: '{count} Runs',
    ...
    graph: {
      ...
      loading: 'Loading the frozen Workflow Graph and Node activity…',
      loadFailed: 'Could not load this Run’s Workflow Graph',
      catalogLoadFailed: 'Could not load the Workflow Node catalog',
      nodeSummaryLoadFailed: 'Could not refresh Node activity',
      availability: 'Graph: {value}',
      empty: 'No frozen Workflow Graph is available for this Run.',
      emptyByAvailability: {
        not_enabled: 'Monitoring was not enabled for this Run.',
        unavailable: 'The frozen Workflow Graph is currently unavailable.',
        capturing: 'The frozen Workflow Graph is still being captured.',
        available: 'No frozen Workflow Graph was stored for this Run.',
        partial: 'Only partial Graph data was captured and no document is available.',
        pending: 'The frozen Workflow Graph is pending.',
        not_applicable: 'A Workflow Graph does not apply to this Run.',
      },
      partial: 'This Graph is shown from {availability} persisted data.',
      nodeSummaryPartial: 'Node activity is {availability}; the Graph remains available.',
      noAttempts: 'No recorded attempts',
      attemptSummary: 'Attempts: {count} · {statuses}',
      statusCount: '{status}: {count}',
      openNodeAttempts: 'Open attempt history for Node {node}',
      unconfiguredAgent: 'No Agent configuration ID',
      unconfiguredCommand: 'No Command configuration ID',
      nodeTypes: {
        start: 'Start',
        agent: 'Agent',
        command: 'Command',
    ...
    nodeAttempts: {
      ...
      close: 'Close Node attempt history',
      recordedCount: '{count} recorded attempts',
      loading: 'Loading Node attempt history…',
      loadFailed: 'Could not load this Node’s attempt history',
      partial: 'Node attempt data is {availability}.',
      empty: 'No Node attempts were returned.',
      ...
      pagination: 'Node attempt history pages',
      viewLatest: 'View latest attempts',
    },
    agent: {
      selectInvocation: 'Select an invocation to view its recorded data.',
      message: 'message',
      structuredBlock: 'structured content',
      completedArtifact: 'Completed invocation messages',
      loadingArtifact: 'Loading the completed invocation artifact…',
      loadArtifactFailed: 'Could not load the completed Agent invocation',
      artifactAvailability: 'Completed invocation data is {availability}.',
      noCompletedMessages: 'No completed invocation messages are available.',
      rawArtifact: 'Raw invocation artifact',
      loadProtocolFailed: 'Could not load this Agent invocation’s event stream',
    },
    protocol: {
      title: 'Recorded event stream',
      loading: 'Loading recorded events…',
      loadFailed: 'Could not load recorded Protocol events',
      availability: 'Recorded event data is {availability}.',
      empty: 'No recorded events are available.',
      structuredEvent: '{method} structured event',
      rawEvent: 'Raw event',
    ...
    command: {
      title: 'Command observations',
      loading: 'Loading Command observations…',
      loadFailed: 'Could not load this Command Node’s observations',
      availability: 'Command observation data is {availability}.',
      empty: 'No Command observations are available.',
      phases: {
        started: 'Started',
        completed: 'Completed',
        failed: 'Failed',
    ...
    models: {
      ...
      loading: 'Loading Model requests…',
      loadFailed: 'Could not load Model requests',
      availability: 'Model request data is {availability}.',
      empty: 'No Model requests are available.',
      usage: 'Usage',
      rawRequest: 'Raw request',
      pagination: 'Model request pages',
      statuses: {
        running: 'Running',
        completed: 'Completed',
        failed: 'Failed',
    ...
    state: {
      title: 'Latest persisted Checkpoint State',
      loading: 'Loading the latest persisted State…',
      loadFailed: 'Could not load the latest persisted State',
      availability: 'Persisted State is {availability}.',
      empty: 'No persisted Checkpoint State is available.',
  ...
  systemSettings: {
    ...
    langgraphDev: {
      ...
      toolsHelp: 'Both links use the active Agent Shell service port. Authenticate with the management Bearer token; Studio is hosted by LangSmith and connects back to this server.',
    },
    runtimePolicy: {
      title: 'Restriction policy',
      retainedLifecycles: 'Completed Lifecycle retention',
      retainedLifecyclesHelp: 'Keep the most recently updated completed Lifecycles. Zero deletes every completed Lifecycle; active Lifecycles do not count. Lowering the value immediately removes excess Threads, Runs, and Agent Shell Store data through public LangGraph APIs.',
  ...
  errors: {
    ...
    mcpInstallationNotApplicable: 'Remote HTTP MCP connections do not require local installation.',
    mcpInstallationFailed: 'The managed local MCP package could not be installed.',
    mcpConnectionTestFailed: 'The installed MCP Server could not complete Tool discovery.',
