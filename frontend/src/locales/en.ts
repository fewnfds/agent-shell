...
export const en: MessageSchema = {
  ...
  systemSettings: {
    ...
    langgraphSaveFailed: 'Could not save LangGraph Dev settings',
    langsmithSaveFailed: 'Could not save LangSmith settings',
  ...
  apiServer: {
    ...
    endpoints: {
      ...
      managementAuth: 'Agent Shell API (except Health) and LangGraph resource routes use Management Bearer.',
      apiKeyAuth: 'The OpenAI-compatible API uses API Key Bearer.',
    },
  },
  errors: {
