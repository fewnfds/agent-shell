...
export const en: MessageSchema = {
  ...
  systemSettings: {
    ...
    responseScheduling: {
      title: 'Response stream scheduling',
      idleTimeout: 'Idle handoff timeout',
      maxBatch: 'Maximum send batch',
      sendInterval: 'Minimum send interval',
    },
    langsmith: {
      title: 'LangSmith',
    ...
    responseSchedulingInvalid: 'Idle timeout and batch size must be positive; send interval may be zero.',
    ...
    responseSchedulingSaved: 'Response stream scheduling saved for new requests.',
    ...
    responseSchedulingSaveFailed: 'Could not save response stream scheduling',
