...
export const en: MessageSchema = {
  ...
  workflowLifecycles: {
    ...
    persistenceUpgradeTitle: 'Monitoring read interface in progress',
    persistenceUpgrade: 'The new runtime persistence system is active. This page currently exposes only the trustworthy Lifecycle catalog and deletion controls. Graph, event details, and runtime archives will become available when the monitoring read model is ready.',
    ...
    deleteDescription: 'Permanently delete runtime monitoring data, runtime Store records, and checkpoints for “{name}”? Managed dynamic directories and ordinary files are retained.',
    deleted: 'Runtime data deleted.',
    deleteFailed: 'Could not delete runtime data',
    bulkDelete: {
      action: 'Bulk delete',
      title: 'Bulk delete runtime data',
      description: 'Permanently delete runtime monitoring data, runtime Store records, and checkpoints for terminal Lifecycles among the {count} matches. Active Lifecycles, managed dynamic directories, and ordinary files are retained.',
