...
export const en: MessageSchema = {
  ...
  styleBaseline: {
    ...
    marker: 'FRONTEND ONLY / GENERATED AUDIT',
    heading: 'Management console style baseline',
    description: 'The top renders approved AdminLTE/Bootstrap combinations. The inventory below is generated from source templates, project CSS, and ui-policy.json.',
    controls: 'Audit filters',
    search: 'Search class or source',
    searchPlaceholder: 'For example: card or management-console.css',
    filter: 'Scope',
    onlySuspect: 'Show unregistered styles only',
    generatedFrom: 'The inventory is regenerated from ui-policy.json, Vue templates, and project CSS during frontend dev/build.',
    usedClasses: 'used classes',
    suspect: 'suspect',
    components: 'Approved component samples',
    buttons: 'Buttons and actions',
    outline: 'Outline (Bootstrap only)',
    ...
    switch: 'Enable streaming output',
    checkbox: 'Retain runtime logs',
    content: 'Tables and content containers',
    type: 'Type',
    status: 'Status',
    ready: 'Ready',
    draft: 'Draft',
    accordion: 'Accordion',
    accordionFirst: 'First drawer',
    accordionSecond: 'Second drawer',
    accordionDetail: 'Continuous content uses the AdminLTE Accordion without another card layer.',
    inventory: 'Generated class inventory',
    className: 'Class',
    usage: 'Template uses',
    source: 'Source',
    approved: 'Registered',
    ...
    suspectTitle: 'Unregistered styles detected',
    suspectDetail: '{count} classes are not registered in a ui-policy.json recipe. Decide whether each is a real product style before adding it to the baseline.',
    cleanTitle: 'Style inventory is clean',
    cleanDetail: 'Every class used by the current source is present in a ui-policy.json recipe.',
  },
  eventFeed: {
    title: 'Log center',
