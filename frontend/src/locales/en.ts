...
export const en: MessageSchema = {
  ...
  workflowLifecycles: {
    ...
    downloadFailed: 'Could not download Lifecycle monitoring data',
    columns: {
      graphs: 'Graphs',
      created: 'Created',
      status: 'Status',
    ...
    cancel: 'Cancel runs',
    cancelTitle: 'Cancel a running Lifecycle',
    cancelDescription: 'Cancel the running Runs of “{name}” and end the request response that is still waiting?',
    cancelled: 'The running Runs were cancelled.',
    cancelFailed: 'Could not cancel the running Runs',
  ...
  runtimeMonitoring: {
    ...
    externalAgent: {
      ...
      result: 'Result',
      events: 'Events',
      noEvents: 'No events were recorded.',
    },
    ...
    workflow: {
      title: 'Workflow',
      empty: 'No Graph data is available.',
    },
    agent: {
      title: 'Agent stream',
  ...
  systemSettings: {
    ...
    providerNetwork: {
      ...
      transports: {
        ...
        curlCffi: 'Browser-compatible (curl-cffi / Chrome fingerprint)',
      },
      ...
      caBundle: 'Custom CA file (optional)',
      caBundlePlaceholder: 'Absolute path, or relative to the data root',
      proxyUrl: 'Explicit HTTP(S) proxy (optional)',
  ...
  fields: {
    ...
    tool_guidance: 'Tool usage notes',
    permission_allow: 'Permission allow rules',
  ...
  editors: {
    ...
    filesystem: {
      ...
      mappingExamples: {
        localDirectory: 'H:\\work or work',
        sourceDirectory: 'H:\\templates or templates',
        sourceFile: 'H:\\config\\default.md or config\\default.md',
      ...
      systemPromptTitle: 'Filesystem system prompt',
    },
    filesystemTools: {
      limitsTitle: 'Tool constraints',
      toolsTitle: 'Filesystem tools',
    ...
    skill: {
      ...
      instructionTitle: 'Skill system prompt',
    ...
    todoList: {
      ...
      systemPromptTitle: 'Todo List system prompt',
      toolDescriptionTitle: 'Todo List tools',
    },
    summarization: {
  ...
  mcpTools: {
    ...
    statusTitle: 'MCP Tool status',
    newStatus: 'Not saved',
    loadFailed: 'Could not load MCP Tools',
    saved: 'MCP Tool saved.',
    copied: 'MCP Tool copied.',
    deleted: 'MCP Tool deleted.',
    deleteTitle: 'Delete MCP Tool',
    deleteDescription: 'Delete MCP Tool “{name}”?',
    ...
    copy: {
      title: 'Copy MCP Tool',
      nameRequired: 'Enter a name for the copied MCP Tool.',
    },
    editor: {
      title: 'MCP Tool canvas',
    },
  },
  workflowComponents: {
  ...
  configurationBundle: {
    issues: {
      ...
      filesystem_path_origin_required: 'Choose an absolute path or a path relative to the instance data root.',
      ...
      filesystem_relative_target_missing: 'The data-root-relative filesystem path does not exist on this instance.',
  ...
  errors: {
    mcpToolInvalid: 'The MCP Tool configuration is invalid.',
    ...
    externalAgentNotFound: 'The External Agent preset does not exist.',
    externalAgentSessionNotFound: 'The External Agent session does not exist in this Lifecycle.',
  ...
  agents: {
    external: {
      ...
      agentDefinitionTitle: 'Agent definition',
      invocationTitle: 'Invocation',
      capabilitiesTitle: 'Capabilities',
      provider: {
        'antigravity-cli': 'Antigravity CLI',
      },
      effortDefault: 'CLI default',
      excludeDefaults: 'Deny built-in components and tools first',
      effort: {
        low: 'Low',
        medium: 'Medium',
        high: 'High',
      },
      modelDefault: 'Account default',
      conversationValue: {
        new: 'New session each run',
        'continue-latest': 'Continue the most recent session',
      },
      toolPermission: {
        'request-review': 'Ask before write, shell, and web tools',
        'proceed-in-sandbox': 'Proceed inside the sandbox',
    ...
    actions: {
      saveDraft: 'Save draft',
      publish: 'Publish Main Agent',
    },
    feedback: {
      newDraft: 'A new draft is ready.',
      loadFailed: 'Could not load the configuration',
      saved: 'The configuration was saved.',
      draftSaved: 'The Main Agent draft was saved.',
      saveFailed: 'Could not save the configuration',
      published: 'The Main Agent was published.',
      publishFailed: 'Could not publish the Main Agent',
  ...
  validation: {
    ...
    resolution: {
      ...
      filesystemBackendRequired: 'Attach a Filesystem Backend or remove Filesystem Tools.',
      skillFilesystemToolsRequired: 'Attach Filesystem Tools so the model can read the Skill SKILL.md, or remove the Skill Package from the Filesystem Backend.',
      filesystemPromptToolsRequired: 'Attach Filesystem Tools or remove the Filesystem Backend system prompt override.',
      executeLocalShellRequired: 'Use a LocalShellBackend or disable the execute Tool.',
      ...
      subagentCapabilityRequired: 'Attach the synchronous Subagent capability or remove all Subagent references.',
      summarizationArchiveUnreadable: 'Attach Filesystem Tools if the model must read summarized history again.',
      mainAgentDraft: 'Open the Main Agent, correct any validation errors, and publish it before running it.',
    ...
    issue: {
      ...
      contract: {
        ...
        externalAgentEnvReserved: '{field} must not override HOME, USERPROFILE, or XDG_CONFIG_HOME.',
      ...
      assembly: {
        ...
        filesystemBackendRequired: 'Filesystem Tools require a Filesystem Backend.',
        skillFilesystemToolsRequired: 'A Skill Package on a Filesystem Backend requires Filesystem Tools so the model can read SKILL.md.',
        filesystemPromptToolsRequired: 'A Filesystem Backend system prompt override requires Filesystem Tools.',
        executeLocalShellRequired: 'The execute Tool requires a LocalShellBackend.',
        ...
        subagentCapabilityRequired: 'Subagent references exist, but the synchronous Subagent capability is not attached.',
        summarizationArchiveUnreadable: 'Summarization can archive history, but without Filesystem Tools the model cannot read that archive again.',
      },
      publication: {
        mainAgentDraft: 'The selected Main Agent is still a draft and cannot run.',
      },
      pythonPackage: {
