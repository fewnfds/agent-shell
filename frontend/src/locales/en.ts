...
export const en: MessageSchema = {
  ...
  workflows: {
    ...
    editor: {
      ...
      commandRouter: 'Deterministic branch routing',
    ...
    fields: {
      ...
      durability: 'Checkpoint save timing',
  ...
  workflowLifecycles: {
    ...
    tableAriaLabel: 'Lifecycle runtime catalog',
    empty: 'No Lifecycles exist.',
    filteredEmpty: 'No Lifecycle matches the current query.',
    loadFailed: 'Could not load the runtime catalog',
    searchPlaceholder: 'Search Graph, Lifecycle, or request ID',
  ...
  capabilities: {
    ...
    'async-subagent': {
      label: 'Async Subagent Middleware',
    },
    summarization: {
  ...
  editors: {
    ...
    asyncSubagent: {
      ...
      toolDescriptionsTitle: 'Async task tool descriptions',
      availableAgentsHint: 'A custom start_async_task description must retain {available_agents}; runtime replaces it with the current valid Async Subagent list.',
    },
    todoList: {
  ...
  agents: {
    ...
    mainAgent: {
      ...
      onDisconnect: { cancel: 'Cancel run', continue: 'Continue run' },
      checkpointMode: { enabled: 'Enabled', disabled: 'Disabled' },
    ...
    asyncSubagentEntity: {
      ...
      templateAssembly: 'Graph, model, tools, middleware, MCP, and filesystem',
      inheritTemplate: 'Use the template Main Agent current configuration',
      checkpointFixed: 'Enabled (fixed for Async Subagent)',
      durabilityFixed: 'Async (fixed for Async Subagent)',
      noticeTitle: 'Synchronous and asynchronous Subagents',
      noticeAsync: 'An Async Subagent returns a task ID immediately and runs in a separate Thread. The parent Agent can continue responding and use fixed tools to check, update, cancel, and list tasks.',
      noticeSync: 'A synchronous Subagent blocks the parent Agent until it returns one final result and does not retain its own Thread State between calls.',
      noticeAssembly: 'This page stores only a reusable template reference and model-visible text. A Main Agent gets async task tools only after explicitly attaching the Async Subagent Middleware component.',
    },
    middleware: {
  ...
  validation: {
    ...
    resolution: {
      ...
      asyncSubagentReferenceRequired: 'Reference at least one Async Subagent configuration, or remove the Async Subagent Middleware component when async delegation is not needed.',
    ...
    issue: {
      ...
      assembly: {
        ...
        asyncSubagentReferenceRequired: 'Async Subagent Middleware is selected, but no usable Async Subagent configuration is referenced.',
      },
      pythonPackage: {
