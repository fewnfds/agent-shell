...
export const en: MessageSchema = {
  ...
  workflowLifecycles: {
    ...
    columns: {
      ...
      tokens: 'Tokens',
      capture: 'Monitoring capture',
    },
    lifecycleStatuses: {
      deleting: 'Deleting',
      purge_pending: 'Pending automatic purge',
    },
    runStatuses: {
      pending: 'Pending',
      running: 'Running',
    ...
    deleteDescription: 'Permanently delete runtime monitoring data, runtime Store records, and checkpoints for “{name}”? Files and directories created during the run remain yours and are retained.',
    deleted: 'Runtime data deleted.',
    deleteFailed: 'Could not delete runtime data',
    bulkDelete: {
      action: 'Bulk delete',
      title: 'Bulk delete runtime data',
      description: 'Permanently delete runtime monitoring data, runtime Store records, and checkpoints for terminal Lifecycles among the {count} matches. Active Lifecycles and files or directories created during runs are retained.',
  ...
  systemSettings: {
    ...
    runtimePolicy: {
      ...
      runtimeMonitoringRetentionHelp: 'Keep the most recently fully terminal Lifecycles. Zero disables monitoring capture for new Lifecycles and permanently clears terminal runtime data; active Lifecycles do not count. Lowering this value immediately purges excess history.',
