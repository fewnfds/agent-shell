...
const resolutionKeys: Record<string, string> = {
  ...
  'assembly.filesystem_backend_required': 'filesystemBackendRequired',
  'assembly.skill_filesystem_tools_required': 'skillFilesystemToolsRequired',
  'assembly.filesystem_prompt_tools_required': 'filesystemPromptToolsRequired',
  'assembly.execute_local_shell_required': 'executeLocalShellRequired',
  'assembly.subagent_invalid': 'subagentInvalid',
  'assembly.subagent_reference_required': 'subagentReferenceRequired',
  'assembly.subagent_capability_required': 'subagentCapabilityRequired',
  'assembly.summarization_archive_unreadable': 'summarizationArchiveUnreadable',
  'publication.main_agent_draft': 'mainAgentDraft',
